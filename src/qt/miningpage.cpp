...
void MiningPage::minerError(QProcess::ProcessError error)
{
    ...
    {
        reportToList("Miner failed to start. Make sure you have the minerd executable and libraries in the same directory as caucasianmineralwaters-qt.", ERROR, NULL);
    }
}
