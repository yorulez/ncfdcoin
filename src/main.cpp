...
uint256 hashGenesisBlock("0xc805fb0ba870a1bb4927186666a60b1e89bfbb1c0bf8ea2b16f257b796ff96fb");
...
const string strMessageMagic = "CMWCoin Signed Message:\n";
...
static const int64 nTargetTimespan = 2 * 24 * 60 * 60; // CMWCoin: 1 days
static const int64 nTargetSpacing = 300; // CMWCoin: 2 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal cmwcoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "CMWCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xbca9e2852c3ef6ee21d71713c9254308a9597762f6697fe1dfff35c9e782998f");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        if (fasle && block.GetHash() != hashGenesisBlock)
        {
